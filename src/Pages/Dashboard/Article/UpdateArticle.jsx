...
export default function UpdateArticle() {
  ...
  useEffect(() => {
    if (article) {
      ...
      setSelectedGeo(article.geometry_id);
  ...
  async function handleSubmit(e) {
    ...
    form.append("text", text);  // يجب أن يكون text هنا بدلاً من title
    form.append("image", image);
    form.append("geometry_id", selectedGeo);

    try {
       await Axios.post(`${baseUrl}/update-article/${id}`, form);
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="input-image">
              ...
              <input
                ...
                id="file-input"
              />
               {/* <span className="image_span" style={{ marginLeft: "2px" }}>
                <a target="blank" href={`http://127.0.0.1:8000/${image}`} className="ats" style={{marginLeft:'5px'}}>
                  View
                </a>
              </span> */}
              {errors.image && (
