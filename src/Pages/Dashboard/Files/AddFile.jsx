...
export default function AddFile({idf,level}) {
  ...
  let idValue = idf === "office_id" ? location.state?.idValue : idf === "recent_id" ? location.state?.idValue : idf === "geometry_id" ? location.state?.idValue : "";
