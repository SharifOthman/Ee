...
export default function UpdateRecent(){
  ...
  async function handleSubmit(e) {
    ...
    form.append("description", description);  // يجب أن يكون text هنا بدلاً من title
    if (image) {
      form.append("image", image);
    }
    try {
      await Axios.post(`${baseUrl}/update-recent/${id}`, form);
