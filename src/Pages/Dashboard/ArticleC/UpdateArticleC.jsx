...
export default function UpdateArticleC({idf,level}) {
  ...
  let idValue =
  idf === "office_id"
    ? location.state?.article?.office_id
    : idf === "recent_id"
    ? location.state?.article?.recent_id
    : idf === "geometry_id"
    ? location.state?.article?.geometry_id
    : "";
